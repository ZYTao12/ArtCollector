...
class ApiManager {
  ...
  static Future<ApiCallResponse> requestWithBody(
    ...
    if (bodyType == BodyType.MULTIPARTPATH) {
      return multipartPathRequest(type, apiUrl, headers, params, returnBody,
  ...
  static Future<ApiCallResponse> multipartPathRequest(
    ApiCallType? type,
    String apiUrl,
    Map<String, dynamic> headers,
    Map<String, dynamic> params,
    ...
    bool Function(dynamic) _isFile = (e) => e is File;
    ...
    params.entries.where((e) => _isFile(e.value)).forEach((e) async {
